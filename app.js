...
const mongoUrl = "mongodb+srv://uasprakdpm:admin19@cluster0.9zta41t.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/createschedule", async (req, res) => {
      const { tgl, hari, jumlah} = req.body;
...
app.post("/updateschedule", async (req, res) => {
      const { scheduleId, tgl, hari, jumlah } = req.body;
